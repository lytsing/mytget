...
const char* FtpParser::get_file(void) {
    return file;
};

const char* FtpParser::get_link(void) {
    return link;
};

off_t FtpParser::get_size(void) {
    return size;
};

time_t FtpParser::get_time(void) {
    return time;
};

char FtpParser::get_type(void) {
    return type;
};
 ...
 */
int FtpParser::process_dos(char *line) {
    struct tm tmp;
 ...
 * */
int FtpParser::process_unix(char *line) {
    struct tm tmp;
    type = *line;
...
int FtpParser::parse(const char *line) {
    assert(line != NULL);
